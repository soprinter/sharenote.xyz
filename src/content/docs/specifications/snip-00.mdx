...
Builders do not need to manually implement continuous difficulty floating-point logic. By invoking `npx skills add soprinter/skills --skill sharenote`, your AI assistant natively understands the strict mathematics outlined in this specification.

...
Builders do not need to manually parse or construct Kind 35502 arrays. By invoking `npx skills add soprinter/skills --skill sharenote`, your AI assistant natively understands the precise tagging architecture outlined in this specification.
